...
> 🎬 **演示视频制作中** —— 上线后此处将直接跳转到视频平台（哔哩哔哩 / YouTube）观看约 3 分钟的完整工作流演示。
>
> 💡 想立即体验？克隆本项目，本地运行只需 5 分钟，无需任何账号或密钥（见「本地运行」）。
...
打开 http://localhost:3000 即可体验（这是本机地址，仅你自己可见）。默认使用演示用户 + 演示引擎，**无需任何密钥或账号**：
